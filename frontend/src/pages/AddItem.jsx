...
function AddItem() {
  // OWNER DASHBOARD  ADD FOOD ITEMS PAGE  (onclick navbar "add fodd items" then this page)
  ...
  return (
    <div className="flex justify-center flex-col items-center p-6 bg-linear-to-r from-orange-50 relative to-white min-h-screen">
      {/* Back Button  */}
      <div
        className="absolute top-8 left-8 z-10 mb-2.5 cursor-pointer"
        onClick={() => navigate("/")}
      >
      ...
      <div className="max-w-lg w-full bg-white shadow-xl rounded-2xl p-8 border border-orange-100">
        ...
        <div className="flex flex-col items-center mb-6">
          ...
          <div className="text-3xl font-bold text-gray-900">Add Food Items</div>
        </div>
